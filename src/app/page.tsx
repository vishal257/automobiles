    ...
    <>
      ...
      <div className=" w-4/6 mx-auto text-center my-12">
        <div className="grid justify-items-center space-y-4 p-2">
          ...
          <div className="uppercase pt-4"><button className="bg-red-800 px-6 py-2 font-bold text-white text-xl hover:bg-red-900"><Link href="/appointment">Schedule and appointment</Link></button></div>
        </div>
      </div>
    </>
