    ...
    <>
      ...
      <div className=" w-4/6 mx-auto text-center my-12">
        <div className="grid justify-items-center space-y-4 p-2">
          <div className="uppercase font-black text-5xl">ABOUT Satyam AUTO WORKS AUTO REPAIR</div>
          ...
          <div className="uppercase pt-4"><button className="bg-red-800 px-6 py-2 font-bold text-white text-xl hover:bg-red-900">Schedule and appointment</button></div>
        </div>
      </div>
    </>
